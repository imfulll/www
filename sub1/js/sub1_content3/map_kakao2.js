window.onload = function () {
  ...
  $(".tab").click(function (e) {
    ...
    $(".map").hide();
    $(".mapInfo").hide();
    $(this).find(".map").fadeIn();
    $(this).find(".mapInfo").fadeIn();

    $(".tab h3").removeClass("current2");
    $(this).find("h3").addClass("current2");

    setTimeout(function () {
      map2.relayout();
      map2.setCenter(new daum.maps.LatLng(37.500687, 127.00326));
    }, 0);
  });

  var container = document.getElementById("map1");
  var options = {
    center: new daum.maps.LatLng(37.54556, 126.951653),
    level: 2,
  };
  ...
  var markerPosition = new daum.maps.LatLng(37.54556, 126.951653);
  ...
  var options2 = {
    center: new daum.maps.LatLng(37.500687, 127.00326),
    level: 2,
  };
  ...
  var markerPosition2 = new daum.maps.LatLng(37.500687, 127.00326);
